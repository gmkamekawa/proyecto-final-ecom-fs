...
public class ProductMapper {
    public static Product dtoToEntity(ProductDTORequest productDTORequest, Category category, List<User> users) {
    ...
    public static ProductDTOResponse entityToDTO(Product product) {
        ...
        return new ProductDTOResponse(product.getId(),product.getName(), product.getPrice(), product.getUrl_image(), product.isFeatured(), product.getDescription(), categoryName, userNames);
    }
}
